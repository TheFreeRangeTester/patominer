    ...
    <div className="min-h-screen">
      ...
      <section className="py-16 bg-gray-50 dark:bg-gray-900">
        <div className="container mx-auto px-4">
          {/* Call to Action para Register Interest */}
          <div className="mb-12 text-center bg-white dark:bg-gray-800 border-2 border-amber-500 dark:border-amber-600 rounded-lg p-6 shadow-lg">
            <h2 className="text-2xl font-bold mb-3 text-black dark:text-white">
              Interested in these workshops?
            </h2>
            <p className="text-lg mb-4 text-gray-700 dark:text-gray-300">
              Help us define the format and timing that best suits you. Express
